...
<body>
    ...
    <div class="container">
      ...
      <a class="text-danger float-left" href="viewonetopic.php?topicId=<?php echo $topicId?>">[Back]</a>
      
      <a class='btn btn-danger text-light float-right' href="requesttutorial.php?tutorId=<?php echo $tutorId?>&tuteeId=<?php echo $tuteeId?>"  style="margin-right: 1%; margin-top: 8px;">Request For Tutorial</a>
      <div style="clear: both;"></div>
      <br>
      ...
      <form method="POST" action="viewonetutor.php?tutorId=<?php echo $tutorId ?>">
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input type="email" class="form-control" id="email" placeholder="Email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Invalid Email Please Enter Valid Email (eg. johndoe@email.com)" value="<?php echo $tutor->email ?>" readonly>
          </div>

          <div class="form-group col-md-6">
            <label for="inputCity">Mobile Phone Number</font></label>
            <input type="Number" class="form-control" id="contact" placeholder="099999999" name="contact" value="<?php echo $tutor->contact ?>" readonly>
          </div>
        </div>
