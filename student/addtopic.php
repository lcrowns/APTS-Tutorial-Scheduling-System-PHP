...
<div class="container">
    ...
    <a class="text-danger" href="mytutorprofile.php?userId=<?php echo $userId;?>">[Back]</a>
    <br>
	  						...
	  						<table class='table table-hover'>
								...
								<tbody>";
       							if($stmt->rowCount()>0){
									...
									<td class='text-center'><a class='btn btn-danger' href='addtopic2.php?tutorId={$tutorId}&subjId={$subjId}&userId={$userId}' role='button'>Select</a></td>
									</tr>
									</tbody>
									";
  								}
