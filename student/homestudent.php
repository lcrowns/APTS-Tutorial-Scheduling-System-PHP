...
$tutorial = new Tutorial($db);
$stmtReq = $tutorial->viewTutorials($name,'','Pending');
?>
...
<body>
  ...
  <ul class="nav nav-tabs" id="myTab" role="tablist" style="max-width: 100%">
      ...
      <li class="nav-item">
        <a class="nav-link active" id="active-tab" data-toggle="tab" href="#active" role="tab" aria-controls="active" aria-selected="true">Accepted</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" id="inactive-tab" data-toggle="tab" href="#inactive" role="tab" aria-controls="inactive" aria-selected="true">Declined</a>
      </li>
      <li class="nav-item">
      ...
      <?php if($account->ifTutor($thisaccountud) && $stmtReq->rowCount()>0){
      echo '
      <li class="nav-item" >
        <a class="nav-link text-danger" id="requests-tab" data-toggle="tab" href="#requests" role="tab" aria-controls="requests" aria-selected="false">Requests(';echo $stmtReq->rowCount();echo ')</a>
      </li>';
      }?>
      <li class="nav-item">
        <?php if($_POST){
          echo '<a class="nav-link bg-secondary text-light" href="homestudent.php">Reset</a>' ;
        }?>
      </li>
  </ul>
    <div class="tab-content" id="myTabContent">
      <!--<div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="all-tab"><?php #include "viewtutorial_all.php" ?></div>-->
        <div class="tab-pane fade show active" id="active" role="tabpanel" aria-labelledby="active-tab"><?php include_once "viewtutorial_active.php" ?></div>
        ...
        <div class="tab-pane fade" id="requests" role="tabpanel" aria-labelledby="requests-tab"><?php include "viewtutorial_request.php" ?></div>
    </div>
  </form>
</div>
