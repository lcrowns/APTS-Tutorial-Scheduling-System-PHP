...
<body>
  ...
  <div class="card-header"><h1><p class="text-center">My Account</p></h1></div>
      <form method="POST" action="myaccountadminedit.php?userId=<?php echo $account->userId ?>">
                <br>
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
           <label for="inputCity">Mobile Phone Number *</font></label>
            <input type="text" class="form-control"  name="contact" value="<?php echo $account->contact?>"required >
          </div>
        ...
        <div class="form-row text-right">
          <div class="form-group col-md-12">
            ...
            <a href="myaccountadmin.php?userId=<?php echo $account->userId ?>" class="btn btn-secondary">Cancel</a>
          </div>
        </div>
