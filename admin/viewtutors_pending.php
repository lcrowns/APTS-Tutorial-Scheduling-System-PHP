...
<form method='POST'>
	  						...
	  						<table class='table table-hover'>
								...
								<tbody>";
								  	...
								  	if($_POST && $tutor->searchTutorsPend($_POST['search1'])->rowCount()>0){
  									$srch = $tutor->searchTutorsPend($_POST['search1']);
									...
									<td class='text-center'><a class='btn btn-secondary' href='viewonetutorreq.php?tutorId={$tutorId}' role='button'>View</a></td>
									</tr>";

  }									
}								elseif($_POST && $tutor->searchTutorsPend($_POST['search1'])->rowCount()<1){
									echo 
										"
										<tr>
