...
<div class="btn-group">
  ...
  <div class="dropdown-menu">
    <a class="dropdown-item" href="homeadmin.php">Tutorials</a>
    <div class="dropdown-divider"></div>
    <a class="dropdown-item" href="tutors.php">Tutors</a>
    <a class="dropdown-item" href="tutees.php">Tutees</a>
    <a class="dropdown-item" href="admins.php">Admins</a>
    <div class="dropdown-divider"></div>
    <a class="dropdown-item" href="subjects.php">Subjects</a>
    <div class="dropdown-divider"></div>
    <a class="dropdown-item" href="myaccountadmin.php?userId=<?php echo $_SESSION['userId']?>">My Account</a>
    <div class="dropdown-divider"></div>
