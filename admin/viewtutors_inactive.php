...
<form method='POST'>
	  						...
	  						<table class='table table-hover'>
								...
								<tbody>";
								  	...
								  	if($_POST && $tutor->searchTutorsInac($_POST['search1'])->rowCount()>0){
  									$srch = $tutor->searchTutorsInac($_POST['search1']);
									...
									<div class='text-center' style='margin:0; padding: 5px 0;'>
										<a href='changetutorstat.php?tutorStatus={$tutorStatus}&userId={$userId}' class='btn btn-danger'>Activate</a>
...
}								elseif($_POST && $tutor->searchTutorsInac($_POST['search1'])->rowCount()<1){
									echo 
										"
										<tr>
