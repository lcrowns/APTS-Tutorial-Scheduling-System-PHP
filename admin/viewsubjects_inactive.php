...
<form method='POST'>
	  						...
	  						<table class='table table-hover'>
								...
								if(isset($_POST['search'])){
								  if($subject->searchSubjsInact($_POST['search'])->rowCount()>0){
  									$srch = $subject->searchSubjsInact($_POST['search']);
								...
								elseif($subject->searchSubjsInact($_POST['search'])->rowCount()<1){
									echo 
										"
										<tr>
